    ...
    public class BrandSubscriptions extends SQLiteAssetHelper {
        ...
        public Subscriptions[] getSubscriptions() {
            ...
            for(int i = 0; i < subsLength; ++i) {
                ...
                @SuppressLint("Range") String colorString = c.getString(c.getColumnIndex("color"));
                int color = Color.parseColor(colorString);

                @SuppressLint("Range") String subType = c.getString(c.getColumnIndex("type"));

                if(subType.equals("font")){
                    @SuppressLint("Range") String iconHTML = c.getString(c.getColumnIndex("icon"));
                    ...
                    @SuppressLint("Range") String iconText = c.getString(c.getColumnIndex("icon"));
